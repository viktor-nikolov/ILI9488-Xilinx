...
## Buttons
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { rst_btn0 }]; #IO_L19N_T3_VREF_16 Sch=btn[0]
...
set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports {   CS_pio44 }]; #IO_L9P_T1_DQS_34 Sch=pio[44]
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports {  RST_pio45 }]; #IO_L19P_T3_34 Sch=pio[45]
set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports {   DC_pio46 }]; #IO_L13P_T2_MRCC_34 Sch=pio[46]
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { MOSI_pio47 }]; #IO_L14P_T2_SRCC_34 Sch=pio[47]
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports {  SCK_pio48 }]; #IO_L14N_T2_SRCC_34 Sch=pio[48]
