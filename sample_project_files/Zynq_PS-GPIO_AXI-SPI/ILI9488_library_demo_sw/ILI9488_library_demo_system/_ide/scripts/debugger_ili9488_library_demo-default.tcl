...
fpga -file C:/Temp/for_GitHub/ILI9488_library_demo_sw/ILI9488_library_demo/_ide/bitstream/system_wrapper.bit
targets -set -nocase -filter {name =~"APU*"}
...
targets -set -nocase -filter {name =~"APU*"}
source C:/Temp/for_GitHub/ILI9488_library_demo_sw/ILI9488_library_demo/_ide/psinit/ps7_init.tcl
ps7_init
ps7_post_config
