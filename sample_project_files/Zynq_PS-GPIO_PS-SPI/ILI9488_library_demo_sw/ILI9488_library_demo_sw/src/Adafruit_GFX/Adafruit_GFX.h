/* When porting to AMD Xilinx SoCs I had to do slight modifications to the original Adafruit_GFX.h (https://github.com/adafruit/Adafruit-GFX-Library/blob/master/Adafruit_GFX.h)
