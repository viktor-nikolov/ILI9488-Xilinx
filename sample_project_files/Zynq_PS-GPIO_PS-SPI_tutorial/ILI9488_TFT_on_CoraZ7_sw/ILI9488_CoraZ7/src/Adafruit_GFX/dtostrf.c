/* When porting to AMD Xilinx SoCs I had to do slight modifications to the original Arduino itoa.c (https://github.com/stm32duino/Arduino_Core_STM32/blob/main/cores/arduino/avr/dtostrf.c)
