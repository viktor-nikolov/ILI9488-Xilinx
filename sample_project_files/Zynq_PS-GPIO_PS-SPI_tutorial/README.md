...
The library is configured by editing the header [ILI9488_Xil_setup.h](https://github.com/viktor-nikolov/ILI9488-Xilinx/blob/main/ILI9488-Xilinx_library/ILI9488_Xil_setup.h). (The ILI9488_Xil_setup.h is being included by the [ILI9488_Xil.h](https://github.com/viktor-nikolov/ILI9488-Xilinx/blob/main/ILI9488-Xilinx_library/ILI9488_Xil.h).). We must edit the following section of this header, uncommenting one of the macros for SPI and one of the macros for GPIO:
