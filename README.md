...
For AXI SPI, I, therefore, implemented the private method [ILI9488::writeToSPI](https://github.com/viktor-nikolov/ILI9488-Xilinx/blob/02c794d62e0a02a3f20ddd4021d0de8e7fd4e38e/ILI9488-Xilinx_library/ILI9488_Xil.cpp#L406) [ILI9488::writeToSPI](ILI9488-Xilinx_library/ILI9488_Xil.cpp#L406) using low-level SPI functions (e.g., [XSpi_WriteReg](https://xilinx.github.io/embeddedsw.github.io/spi/doc/html/api/group__spi.html#ga32e741800118678aa060ef2a13661e31)). The implementation doesn't read any data back from the receive FIFO buffer from the AXI SPI IP.  
