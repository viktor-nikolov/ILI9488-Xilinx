...
| SCK        | SPI bus clock signal<br/>rated at 20 MHz<br/>(my specimen of the display worked at ) | PS&nbsp;SPI:&nbsp;SPI*x*_SCLK_O&nbsp;signal&nbsp;(e.g.,&nbsp;SPI0_SCLK_O)<br/><br/>AXI SPI: sck_o signal                |
